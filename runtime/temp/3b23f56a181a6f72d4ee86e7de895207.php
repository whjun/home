<?php /*a:2:{s:74:"E:\phpstudy\PHPTutorial\WWW\PHP\application\admin\view\admin\editmenu.html";i:1559631740;s:26:"./admin-layout/header.html";i:1559631735;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
	...
	<div class="layui-form">
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				...
				<input type="text" name="name" lay-verify="required" placeholder="请输入菜单名称" value="<?php echo htmlentities($info['name']); ?>" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">控制器方法</label>
			<div class="layui-input-inline">
				<input type="text" name="url" placeholder="请输入控制器方法" value="<?php echo htmlentities($info['url']); ?>" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="cate1" id="cate1" lay-filter="cate1">
					...
					<?php if(is_array($cate1) || $cate1 instanceof \think\Collection || $cate1 instanceof \think\Paginator): if( count($cate1)==0 ) : echo "" ;else: foreach($cate1 as $key=>$val): ?>
					<option value="<?php echo htmlentities($val['id']); ?>" <?php if($val['id'] == $info['first']): ?>selected<?php endif; ?>><?php echo htmlentities($val['name']); ?></option>
			...
			<div class="layui-input-inline">
				<select name="cate2" id="cate2" lay-filter="cate2">
					<option value="">请选择</option>
					<?php if(is_array($cate2) || $cate2 instanceof \think\Collection || $cate2 instanceof \think\Paginator): if( count($cate2)==0 ) : echo "" ;else: foreach($cate2 as $key=>$val): ?>
					<option value="<?php echo htmlentities($val['id']); ?>" <?php if($val['id'] == $info['second']): ?>selected<?php endif; ?>><?php echo htmlentities($val['name']); ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="radio" name="status" value="0" title="显示" <?php if($info['status'] == 0): ?> checked<?php endif; ?>>
				<input type="radio" name="status" value="1" title="隐藏" <?php if($info['status'] == 1): ?> checked<?php endif; ?>>
			</div>
		</div>
		<div class="layui-form-item">
