<?php /*a:2:{s:74:"E:\phpstudy\PHPTutorial\WWW\PHP\application\admin\view\admin\editrole.html";i:1559631740;s:26:"./admin-layout/header.html";i:1559631735;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
    ...
    <div class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" name="name" lay-verify="required" placeholder="请输入角色名称" value="<?php echo htmlentities($info['name']); ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">角色描述：</label>
            <div class="layui-input-inline" style="width:600px">
                <textarea name="desc" style="resize:none" id="" class="layui-textarea"><?php echo htmlentities($info['desc']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
