<?php /*a:2:{s:74:"E:\phpstudy\PHPTutorial\WWW\PHP\application\admin\view\admin\adminadd.html";i:1559631740;s:26:"./admin-layout/header.html";i:1559631735;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
...
<div class="admin-main">
	<div class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="password" name="password" lay-verify="required|pass" placeholder="请输入登录密码" value="" autocomplete="new-password" class="layui-input">
			</div>
